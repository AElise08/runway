# GROWGUIDE — Plano de Marketing Viral em 7 Dias
## Projeto Miranda (Runway) · Crescimento 100% Orgânico
...
### Tese central
O Projeto Miranda NÃO é "mais um app de IA". É uma **experiência social compartilhável** — ser julgada por uma editora de moda cruel, rir do resultado e postar. O marketing precisa vender a EXPERIÊNCIA, não a tecnologia.
...
| Gancho | Por quê funciona | Onde usar |
|--------|-----------------|-----------|
| **Humor de humilhação** | Pessoas ADORAM ver notas ruins e roasts cruéis | TikTok, Reels |
...
## 4. BANCO DE ROTEIROS PRONTOS

### Roteiro T1 — "Construí um app que te julga como a Miranda Priestly"
```
[CÂMERA: olhando pra câmera, tom casual/animado]

"Sabe a Miranda Priestly? Aquela editora de moda que destrói 
a autoestima de qualquer um? Então, eu construí um app onde 
ela julga o seu look."

[CORTE: screen recording do app abrindo]

"Você manda uma foto do seu outfit e recebe uma nota de 0 a 100
com um comentário editorial que vai te fazer questionar todas
as suas escolhas de vida."

[CORTE: resultado com nota aparecendo]

"Eu tirei [nota]. Ela disse: [ler a frase principal]."
...
```
[CÂMERA: mostrar o look inteiro primeiro, 2-3 segundos]
[TEXTO NA TELA: "testando meu look no app da Miranda Priestly"]

[CORTE: abrindo o app, escolhendo desafio]
[CORTE: tirando a foto]
[CORTE: tela de loading — "Miranda está verificando se você 
tem o direito de respirar..."]

[BUILD SUSPENSE: 2 segundos de pausa]

[REVEAL: nota aparece na tela]

[REAÇÃO: genuína — rir, fazer cara de choque, ou morrer por dentro]
...
```
[MONTAGEM RÁPIDA com música trending]

Nota 12 — "Demitida antes do café"
Nota 47 — "Sob revisão hostil"
...
```
[CÂMERA: vestida pro trabalho, mostrando o outfit]

"Todo dia eu saio de casa achando que tô apresentável pro 
trabalho. Hoje vou deixar a Miranda decidir."

[SCREEN RECORDING: escolhendo "Look de Trabalho"]
[TIRANDO FOTO]
[LOADING]
[NOTA APARECE]

"[Nota]. Ela disse: [frase]."
...
```
[CÂMERA: tom de apresentadora]

"Vou testar as trends de moda mais hypadas do momento no app 
da Miranda Priestly pra ver quais ela aprova e quais ela 
literalmente demite."

[TREND 1: "quiet luxury"] → [NOTA]
[TREND 2: "mob wife"] → [NOTA]  
[TREND 3: "old money"] → [NOTA]
[TREND 4: "coquette"] → [NOTA]

"A surpresa do dia: [trend inesperada] tirou [nota alta/baixa]."

[FINAL: pergunta pro público]: "Qual trend vocês querem que 
eu teste amanhã?"
```
...
"Vou ver se a Miranda consegue detectar a diferença entre 
meu look de domingo e meu look de sair."

[TESTAR LOOK PIOR] → [NOTA + FRASE]

[TRANSIÇÃO DRAMÁTICA de roupa]

[TESTAR LOOK MELHOR] → [NOTA + FRASE]

"De [nota baixa] pra [nota alta]. Pelo menos ela reconheceu 
meu esforço."
```
...
"2 — Cores sem coerência. Misturar tudo sem intenção."
"3 — Calçado que não conversa com o resto."
...
```
[TEXTO NA TELA: "a Miranda Priestly julgando personagens de filme"]
[MÚSICA: trending sound dramático]

Andy Sachs (antes): [nota] — "[frase]"
Andy Sachs (depois): [nota] — "[frase]"
Elle Woods: [nota] — "[frase]"
Blair Waldorf: [nota] — "[frase]"
...
```
[CÂMERA: sentada, tom reflexivo/storytelling]

"Uma semana atrás eu lancei um app que deixa uma IA te julgar 
como a Miranda Priestly. Eu achei que umas 50 pessoas iam 
testar. Aconteceu o seguinte:"

"[X] pessoas testaram."
"A nota média foi [X]."
"A frase mais compartilhada foi: [frase]."
"[X] pessoas ficaram genuinamente ofendidas."

"Mas o que mais me surpreendeu foi [insight pessoal real]."

"Semana que vem vem novidade. Fica ligado."
```
...
Responde esse email. Eu quero saber.
